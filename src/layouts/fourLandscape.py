...
def buildFourLandscapeCmd(localPaths, offsets, outVideo: Path):
    """
    4 landscape videos → 2x2 grid on a 1920x1080 canvas
    """
    ...
    TILE_W = CANVAS_W // 2    # 960
    TILE_H = CANVAS_H // 2    # 540

    CROP = 0.90  # mild side crop
